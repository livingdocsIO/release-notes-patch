...
Package | Version
--- | ---
`@livingdocs/server` | `v75.17.3`
`@livingdocs/editor` | `v35.24.3`
...
- [v75.17.3](https://github.com/livingdocsIO/livingdocs-server/releases/tag/v75.17.3): fix: fixed a server bug
...
- [v35.24.3](https://github.com/livingdocsIO/livingdocs-editor/releases/tag/v35.24.3): fix: fixed an editor bug
